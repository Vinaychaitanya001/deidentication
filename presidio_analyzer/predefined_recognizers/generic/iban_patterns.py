...
# Source: https://github.com/microsoft/presidio/blob/main/presidio-analyzer/presidio_analyzer/predefined_recognizers/generic/iban_patterns.py
# Copyright (c) Presidio Contributors.
# Per-country IBAN structure regexes, used by iban_recognizer.py's format check.

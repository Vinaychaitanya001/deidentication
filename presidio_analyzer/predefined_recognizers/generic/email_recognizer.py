...
# Source: https://github.com/microsoft/presidio/blob/main/presidio-analyzer/presidio_analyzer/predefined_recognizers/generic/email_recognizer.py
# Copyright (c) Presidio Contributors.
# Requires the third-party `tldextract` package for validate_result().

...
# Source: https://github.com/microsoft/presidio/blob/main/presidio-analyzer/presidio_analyzer/pattern_recognizer.py
# Copyright (c) Presidio Contributors.
# This is THE core class of the regex-only architecture: every predefined
# recognizer in predefined_recognizers/generic subclasses this and supplies
# regex Patterns (+ optional checksum/validation logic). Note analyze()'s
# nlp_artifacts parameter is optional and unused here - PatternRecognizer
# never needs an NLP engine to run.

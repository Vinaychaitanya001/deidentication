...
# Source: https://github.com/microsoft/presidio/blob/main/presidio-analyzer/presidio_analyzer/pattern.py
# Copyright (c) Presidio Contributors.
# Requires the third-party `regex` package (not stdlib `re`) for finditer(timeout=...).
